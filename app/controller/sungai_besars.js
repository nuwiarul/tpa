Ext.define('TPA.controller.sungai_besars', {
    ...
    init: function () {
        ...
        var vecLayer = new OpenLayers.Layer.Vector("Sungai Besar", {
            styleMap: myStyles,
            protocol: new OpenLayers.Protocol.HTTP({
                url: "php/sungai_besar.php",
                format: new OpenLayers.Format.GeoJSON()
            }),
            strategies: [new OpenLayers.Strategy.Fixed()]
        });

        this.getStore('sungai_besars').bind(vecLayer);
