...
Ext.define('TPA.view.grafik.geologi.window' ,{
    extend: 'Ext.window.Window',
    id : 'TPA.view.grafik.geologi.window',
    alias : 'widget.Grafik_GeologiWindow',
    title : 'Grafik Geologi',
    ...
    initComponent: function() {
        ...
        var config = {
            ...
            chartConfig: {
                ...
                title: {
                    text: 'Grafik Fuzzy Layer Geologi',
                    x: -20 //center
                },
